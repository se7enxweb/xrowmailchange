...
<div class="element">
    ...
    {else}
        ...
        <input name="new_mail" type="text" value="{if and(is_set(ezhttp().post.new_mail), ezhttp().post.new_mail|ne(""))}{ezhttp().post.new_mail}{elseif and(is_set($attribute.content.email), $attribute.content.email|ne(""))}{$attribute.content.email|wash( xhtml )}{/if}" />
    {/if}
</div>
